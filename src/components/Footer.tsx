        ...
        <div className="grid md:grid-cols-4 gap-12 border-b border-white/10 pb-12 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
               <a href="https://www.instagram.com/alpsolucionesyservicios/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-accent hover:-translate-y-1 transition-all duration-300 cursor-pointer text-white shadow-sm" aria-label="Instagram">
               ...
               <a href="https://www.facebook.com/alpsoluciones14" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-accent hover:-translate-y-1 transition-all duration-300 cursor-pointer text-white shadow-sm" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
